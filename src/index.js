...
root.render(
  ...
  <Routes>
    ...
    {/*back end projects directory */}
    <Route path="/Backend" element={<Backend/>}/>
    {/*
    </Router>/>
    <Route path="/Backend/TimestampMicroservice" element={<TimestampMicroservice/>}/>
    <Route path="/Backend/RequestHeaderParserMicroservice" element={<RequestHeaderParserMicroservice/>}/>
    <Route path="/Backend/URLShortenerMicroservice" element={<URLShortenerMicroservice/>}/>
    <Route path="/Backend/ExerciseTracker" element={<ExerciseTracker/>}/>
    <Route path="/Backend/FileMetadataMicroservice" element={<FileMetadataMicroservice/>}/>
*/}
